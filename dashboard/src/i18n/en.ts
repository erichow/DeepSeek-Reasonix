export const en = {
  ...
  settings: {
    ...
    webSearchEngineBaidu: "baidu — Baidu AI Search (set BAIDU_API_KEY or QIANFAN_API_KEY)",
    ...
    themeStyleAuroraDesc: "Teal-green dark for a softer low-light workspace.",
    ...
    themeStyleLinenDesc: "Editorial warm light with paper-like surfaces.",
    themeStyleGlacier: "Glacier",
    themeStyleGlacierDesc: "Cool light with crisp blue accents.",
    ...
    thinking: "Thinking",
    thinkingHint: "Enable/disable reasoning for next turn",
