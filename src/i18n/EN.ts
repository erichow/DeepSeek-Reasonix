...
export const EN: TranslationSchema = {
  ...
  ui: {
    ...
    effortHint: "reasoning effort — auto|low|medium|high|max",
    ...
    effortHintShort: "reasoning effort — auto|low|medium|high|max",
  ...
  slash: {
    ...
    effort: {
      description:
        "reasoning_effort cap (auto|low|medium|high|max); auto is the new default — per-turn heuristic",
  ...
  handlers: {
    basic: {
      ...
      clearInfo: "▸ cleared context — dropped {count} message(s). Session continues in place.",
      helpTitle: "Commands:",
    ...
    model: {
      ...
      effortUsage:
        "usage: /effort <{list}>   (auto is the new default; max is a DeepSeek extension)",
      effortUsageNoMax: "usage: /effort <{list}>   (auto selects per-turn heuristically)",
  ...
  modelPicker: {
    ...
    effortDesc: {
      auto: "per-turn \u2014 low for simple Q&A, medium for chat, high for complex tasks, max on repair",
