...
export const zhCN: TranslationSchema = {
  ...
  ui: {
    ...
    effortHint: "推理强度 — auto|low|medium|high|max",
    ...
    effortHintShort: "推理强度 — auto|low|medium|high|max",
  ...
  slash: {
    ...
    effort: {
      description: "推理强度上限（auto|low|medium|high|max）；auto 为新默认 — 每轮启发式选择",
  ...
  handlers: {
    basic: {
      ...
      clearInfo: "▸ 上下文已清空 — 丢弃了 {count} 条消息。会话保持不变。",
      helpTitle: "命令：",
    ...
    model: {
      ...
      effortUsage: "用法：/effort <{list}>   （auto 为新默认；max 是 DeepSeek 扩展）",
  ...
  modelPicker: {
    ...
    effortDesc: {
      auto: "每轮启发式 — 聊天用 low，工具用 high，升级用 max",
      low: "最快 — 极少推理",
      medium: "平衡",
