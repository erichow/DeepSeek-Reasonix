...
export const JA: TranslationSchema = {
  ...
  ui: {
    ...
    effortHint: "推論努力 — auto|low|medium|high|max",
    ...
    effortHintShort: "推論努力 — auto|low|medium|high|max",
  ...
  slash: {
    ...
    effort: {
      ...EN.slash.effort,
      description:
        "reasoning_effort の上限 (auto|low|medium|high|max); auto が新デフォルト — ターン毎のヒューリスティック",
  ...
  handlers: {
    ...
    model: {
      ...
      effortUsage: "使い方: /effort <{list}>   （auto が新デフォルト; max はDeepSeek拡張）",
