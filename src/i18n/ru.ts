...
export const ru: TranslationSchema = {
  ...
  ui: {
    ...
    effortHint: "уровень рассуждений — auto|low|medium|high|max",
    ...
    effortHintShort: "уровень рассуждений — auto|low|medium|high|max",
  ...
  slash: {
    ...
    effort: {
      ...EN.slash.effort,
      description:
        "лимит уровня рассуждений (auto|low|medium|high|max); auto — новое значение по умолч., выбирается автоматически",
    },
